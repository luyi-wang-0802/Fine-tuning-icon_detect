...
def test_single_image():
    ...
    best_model_path = Path("W:/hiwi/post_training/runs/full_dataset/icon_detect_split_dataset/weights/best.pt")
    test_image_path = Path("new_dataset/images/full_train/Confirm Layer Name_1_times_2172.png")
    results_dir = Path("test_results_2")
    ...
    if not test_image_path.exists():
        ...
        print("Please save your building screenshot as 'test_building.png' in the project root directory")
        return
    ...
    try:
        ...
        results = model(test_image_path, conf=0.5, save=False, verbose=True)
        result = results[0]
        ...
        if boxes is not None and len(boxes) > 0:
            ...
            output_path = results_dir / "building_detection_result.png"
            ...
            txt_path = results_dir / "detection_results.txt"
